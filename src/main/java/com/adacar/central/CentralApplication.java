...
public class CentralApplication {
	...
	public static void main(String[] args) {
		...
		Optional<Cliente> pessoaEncontrada = clienteService.buscarPorDocumento("123.456.789-00");
		pessoaEncontrada.ifPresentOrElse(
				pessoa -> System.out.println("Pessoa encontrada: " + pessoa.getNome() + " - " + pessoa.getDocumento()),
				() -> System.out.println("Pessoa não encontrada.")
		);
		clienteService.alterar("João Silva", "123.456.789-00");

		Optional<Cliente> clientePjEncontrada = clienteService.buscarPorDocumento("12.345.678/0001-00");
		clientePjEncontrada.ifPresentOrElse(
				pessoa -> System.out.println("Pessoa encontrada: " + pessoa.getNome() + " - " + pessoa.getDocumento()),
				() -> System.out.println("Pessoa não encontrada.")
		);
		clienteService.alterar("Empresa Tabajara", "12.345.678/0001-00");
